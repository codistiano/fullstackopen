...
test("when the like button is clicked twice, the event handler that increments the likes count is called twice", () => {
    const blog = {
        title: "Testing sucks! Here's how to make it easy.",
        author: "Abudi",
        url: "https://codistiano.com/blogs/Testing_sucks_heres_how_to_make_it_easy",
    ...
    render(<Blog blog={blog} user={user} addLike={mockIncrementLikes} />); 
